...
from crm_app.views  import(
    ...
    ServicePercentageAPI,
    ServicePercentageDetailAPI,
)
...
urlpatterns = [
    ...
    path('servicePercentage/',ServicePercentageAPI.as_view()),
    path('servicePercentage/<int:id>/',ServicePercentageDetailAPI.as_view())
